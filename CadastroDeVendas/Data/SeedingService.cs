...
namespace CadastroDeVendas.Data
{
    public class SeedingService
    {
        ...
        private CadastroDeVendasContext _context;

        public SeedingService (CadastroDeVendasContext context)
        {
            _context = context;
        }

        public void Seed()
        {                   //any Determina se uma sequência contém algum elemento.
            if (_context.Department.Any() || _context.Sellers.Any() || _context.SalesRecords.Any() ) // aqui ele verifica se ja tem o registro no banco
            {
                return; //nesse caso o banco ja foi populado
            }

            Department d1 = new Department(1,"Computadores");
            Department d2 = new Department(2, "Sapatos");

            Department d3 = new Department(3, "Cozinha");
            Department d4 = new Department(4, "Quarto");

            // ou 

            Department d5 = new Department { Id = 5, Name = "Escolar" };
            //-------------------------------------------------------------------- Vendedores
            Seller s1 = new Seller(1,"Israel" ,"israel.ribeiro313@gmail.com",new DateTime (2000,02,08),1000.0,d1 );
            Seller s2 = new Seller(2, "Heloisa", "Heloisa@gamil.com", new DateTime(2002, 03, 12), 2000, d3);

            Seller s3 = new Seller(3, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s4 = new Seller(4, "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 3500.0, d2);
            Seller s5 = new Seller(5, "Alex Grey", "alex@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            Seller s6 = new Seller(6, "Martha Red", "martha@gmail.com", new DateTime(1993, 11, 30), 3000.0, d4);
            Seller s7 = new Seller(7, "Donald Blue", "donald@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
            Seller s8 = new Seller(8, "Alex Pink", "bob@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
            ...
            _context.Sellers.AddRange(s1, s2, s3, s4, s5, s6, s7, s8);
